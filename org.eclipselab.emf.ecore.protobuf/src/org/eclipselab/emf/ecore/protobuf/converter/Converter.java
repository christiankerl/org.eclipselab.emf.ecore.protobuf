...
public interface Converter<Source, SourceType, Target, TargetType> {
	 ...
	 * @author Christian Kerl
	 */
	abstract class FromProtoBufMessageConverter<SourceType extends Message, TargetType extends EObject> implements Converter<SourceType, Descriptors.Descriptor, TargetType, EClass> {
	 ...
	 * @author Christian Kerl
	 */
	abstract class ToProtoBufMessageConverter<SourceType extends EObject, TargetType extends Message> implements Converter<SourceType, EClass, TargetType, Descriptors.Descriptor> {
